        ...
        const afterSubmit = (scriptContext) => {
            try {
                ...
                if ( scriptContext.type === scriptContext.UserEventType.EDIT ) {
                    ...
                    let typeModule = "PoliticasConsumo";
                    ...
                    let data = {
                        ...
                        "activa":"1",
                        "tipo_pago":"0",
                        "limite_credito":record.getText({fieldId:'custrecord_ptg_limitedecredito_pc'}),
                        "hora_inicial":"00:00",
                        "hora_final":"23:45",
                        "numero_servicios":1,
                        "restringir_gps":0,
                    ...
                    log.debug('politicas', record);
                    // let rfcVal = record.getValue({fieldId: 'custentity_mx_rfc'});
                    let res;
                    log.debug('ID politicas', scriptContext.newRecord.id);
                    ...
                    let data = {
                        ...
                        "activa":"1",
                        "tipo_pago":"0",
                        "limite_credito":record.getValue({fieldId:'custrecord_ptg_limitedecredito_pc'}),
                        "hora_inicial":"00:00",
                        "hora_final":"23:45",
                        "numero_servicios":1,
                        "restringir_gps":0,
